    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <Text style={styles.title}>
          {editingCheckInId ? 'Edit' : 'Create'} Check-In Schedule
        </Text>
            ...
            <View key={checkIn.id} style={styles.existingCheckIn}>
              <View style={styles.existingCheckInHeader}>
                <View style={styles.existingCheckInInfo}>
                  ...
                  <Text style={styles.existingCheckInTime}>
              ...
              <Text style={styles.existingCheckInQuestions}>
                {checkIn.questions.length} {checkIn.questions.length === 1 ? 'question' : 'questions'}
              </Text>
              <View style={styles.existingCheckInActions}>
                <TouchableOpacity
                  style={styles.actionButton}
                  onPress={() => handleEdit(checkIn)}
                >
...
export default CheckInSchedulingScreen;
