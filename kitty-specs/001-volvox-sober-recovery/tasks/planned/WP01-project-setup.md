...
- Run `npm test` and verify Jest runs (even with 0 tests)
...
- [ ] React Native app runs on iOS simulator (`npm run ios`)
- [ ] React Native app runs on Android emulator (`npm run android`)
