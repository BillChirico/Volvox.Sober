  ...
  public: {
    Tables: {
      ...
      connections: {
        ...
        Insert: Omit<Database['public']['Tables']['connections']['Row'], 'id' | 'created_at' | 'updated_at' | 'total_messages'>
      ...
      messages: {
        ...
        Insert: Omit<Database['public']['Tables']['messages']['Row'], 'id' | 'created_at' | 'archived'>
