...
async function sendCheckInNotifications(checkInsDue: CheckInDue[]): Promise<CheckInDue[]> {
...
async function sendSponsorAlerts(supabase: any, missedCheckIns: any[]): Promise<any[]> {
  const sponsorAlerts = [];
