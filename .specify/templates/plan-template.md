...
- [ ] Accessibility requirements met (labels, contrast, touch targets, screen readers)
...
- [ ] Images optimized (WebP with JPEG fallback, lazy loading)
...
- [ ] Form inputs validated client-side (Yup) and server-side (Supabase)
