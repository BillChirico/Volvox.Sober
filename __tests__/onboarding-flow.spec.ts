...
test.describe('Onboarding Flow', () => {
  ...
  test('T141.1: Complete onboarding as sponsor', async ({ page }) => {
    ...
    await page.fill('[data-testid="bio-input"]', 'Experienced sponsor with 10 years of sobriety. Here to help others on their journey.')
  ...
  test('T141.2: Complete onboarding as sponsee', async ({ page }) => {
    ...
    await page.fill('[data-testid="bio-input"]', 'New to recovery, looking for guidance and support from an experienced sponsor.')
