...
test.describe('Navigation Flow', () => {
  ...
  test('T146.1: Navigate between all tabs', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="tab-sobriety"]')).toHaveAttribute('aria-selected', 'true')

    // Navigate to Matches tab
    await page.click('[data-testid="tab-matches"]')
    await page.waitForURL(/.*\/matches/)
    await expect(page.locator('[data-testid="matches-screen"]')).toBeVisible()
    await expect(page.locator('[data-testid="tab-matches"]')).toHaveAttribute('aria-selected', 'true')
    ...
    await expect(page.locator('[data-testid="tab-connections"]')).toHaveAttribute('aria-selected', 'true')

    // Navigate to Messages tab
    await page.click('[data-testid="tab-messages"]')
    await page.waitForURL(/.*\/messages/)
    await expect(page.locator('[data-testid="messages-screen"]')).toBeVisible()
    await expect(page.locator('[data-testid="tab-messages"]')).toHaveAttribute('aria-selected', 'true')

    // Navigate to Profile tab
    await page.click('[data-testid="tab-profile"]')
    await page.waitForURL(/.*\/profile/)
    await expect(page.locator('[data-testid="profile-screen"]')).toBeVisible()
    await expect(page.locator('[data-testid="tab-profile"]')).toHaveAttribute('aria-selected', 'true')
  ...
  test('T146.3: Active tab highlighting', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="tab-matches"]')).toHaveAttribute('aria-selected', 'false')
    await expect(page.locator('[data-testid="tab-connections"]')).toHaveAttribute('aria-selected', 'false')
    await expect(page.locator('[data-testid="tab-messages"]')).toHaveAttribute('aria-selected', 'false')
    await expect(page.locator('[data-testid="tab-profile"]')).toHaveAttribute('aria-selected', 'false')
    ...
    await expect(page.locator('[data-testid="tab-sobriety"]')).toHaveAttribute('aria-selected', 'false')
  })
  ...
  test('T146.6: Tab state persistence when navigating', async ({ page }) => {
    ...
    await page.click('[data-testid="filter-button"]')
    await expect(
      page.locator('[data-testid="filter-program-select"]')
    ).toContainText('AA')
  })
