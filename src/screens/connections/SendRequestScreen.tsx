...
import { Text, TextInput, Button, Surface, Avatar, Snackbar } from 'react-native-paper';
import { useRoute, useNavigation } from '@react-navigation/native';
import { useSendRequestMutation } from '../../store/api/connectionsApi';
...
const SendRequestScreen: React.FC = () => {
  ...
  const { sponsorId, sponsorName, sponsorPhotoUrl } = (route.params as RouteParams) || {};
